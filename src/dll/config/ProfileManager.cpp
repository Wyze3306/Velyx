...
const std::vector<Starter>& starters() {
    static const std::vector<Starter> kStarters{
        ...
        {Profile{"PvP", "Hitboxes, the target's health and a capped framerate.",
                 {}, false, false, 0},
         {
             {"notifications"},
             {"performance_mode"},
             ...
             {"hit_marker"},
             {"low_health"},
             {"target_hud", "Top centre", 0.5f, 0.16f},
             {"reach", "Bottom centre", 0.5f, 0.62f},
             {"fps", "Top left", 0.012f, 0.022f},
        ...
        {Profile{"Performance", "The bare minimum on screen, everything else off.",
                 {}, false, false, 0},
         {
             ...
             {"frame_limiter"},
             {"fps", "Top left", 0.012f, 0.022f},
             {"system_monitor", "Top right", 0.988f, 0.022f},
         }},
